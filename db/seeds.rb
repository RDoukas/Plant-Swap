User.create!([
  {username: "SNix", password_digest: "$2a$12$6CnSuldoHIx8SJzv0wq.X.1fI4QjN.o3tlqKGEeasBAdHG9rOo/ba", first_name: "Steph", last_name: "Nixon", email: "snixon@gmail.com"},
  {username: "amyers", password_digest: "$2a$12$896zYxNCnfOnd.xOrCquvexfqhjb6mX5ft4koxrpEldwovKqzYK2W", first_name: "Amy", last_name: "Myers", email: "amyers@gmail.com"},
  {username: "carl", password_digest: "$2a$12$3MXsXMxr.ARuuPeul22gp.RJnytg3svKRCx31du4ohmwQPpYfYkny", first_name: "Carl", last_name: "Hauck", email: "carl@gmail.com"},
  {username: "JakeSnake", password_digest: "$2a$12$ZibUmJktiZo7iEuu/GOMV.0/Ae5v56eAr6n07nyvVB8S5tjei2pre", first_name: "Jacob", last_name: "Doukas", email: "JakeSnake@gmail.com"},
  {username: "Betty", password_digest: "$2a$12$h9RFaLgxELPXlAqOdF8hq.EVg7m2B7fMupKIbQr4JwmSd266te3JS", first_name: "Betty", last_name: "Doukas", email: "Betty@gmail.com"},
  {username: "alex", password_digest: "$2a$12$yZYalgA90KPNd9KwLEGopuz1b3kHumwdBLwDYeBRSpxkjUAwGaSKi", first_name: "Alex", last_name: "Rosales", email: "alex@gmail.com"},
  {username: "beccabagels", password_digest: "$2a$12$nTZySmGE3.eePSxVvE6.PeS3PQyCexVlkTLUlP.3J6zdxjU0sbw9i", first_name: "Becca", last_name: "Doukas", email: "becca@gmail.com"}
])
